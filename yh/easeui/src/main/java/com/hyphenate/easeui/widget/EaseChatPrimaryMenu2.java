 ...
 * primary menu
 */
public class EaseChatPrimaryMenu2 extends EaseChatPrimaryMenuBase implements OnClickListener {
    ...
    public EaseChatPrimaryMenu2(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public EaseChatPrimaryMenu2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EaseChatPrimaryMenu2(Context context) {
        super(context);
        init(context, null);
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.ease_widget_chat_primary_menu2, this);
        editText = (EditText) findViewById(R.id.et_sendmessage);
//        buttonSetModeKeyboard = findViewById(R.id.btn_set_mode_keyboard);
//        edittext_layout = (RelativeLayout) findViewById(R.id.edittext_layout);
        buttonSetModeVoice = (Button) findViewById(R.id.btn_set_mode_voice);
        buttonNews = (Button) findViewById(R.id.btn_news);
