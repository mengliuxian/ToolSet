...
import com.flym.yh.adapter.home.DoctorLectureAdapter;
...
public class DoctorLectureFragment extends BaseFragment {
    ...
    private DoctorLectureAdapter mAdapter;
    private int isRefresh;

    public static DoctorLectureFragment newInstance() {

        Bundle args = new Bundle();

        DoctorLectureFragment fragment = new DoctorLectureFragment();
    ...
    private void setAdapter() {
        mAdapter = new DoctorLectureAdapter(dataList, type);
    ...
    protected int getLayoutRes() {
        return R.layout.fragment_doctor_lecture;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_new:
                if (type == 0) {
                    isRefresh = 1;
                    FragmentUtil.replaceFragmentToActivity(R.id.container, NewDoctorLectureFragment.newInstance(), getFragmentManager(), getString(R.string.publish_class));
