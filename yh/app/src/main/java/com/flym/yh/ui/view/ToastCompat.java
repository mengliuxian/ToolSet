...
public class ToastCompat extends Toast {
    ...
    public static Toast makeText(Context context, CharSequence text,int duration) {
        ...
        View v = inflate.inflate(resources.getIdentifier(
                "transient_notification", "layout", "android"), null);
        TextView tv = (TextView)v.findViewById(resources.getIdentifier
                ("message", "id", "android"));
        tv.setText(text);
        result.setView(v);
        ...
        try {
            ...
            if(mTN!=null){
                ...
                if(rawShowRunnable!=null && rawShowRunnable instanceof Runnable){
                    isSuccess=setFieldValue(mTN,"mShow"
                            ,new InternalRunnable((Runnable)rawShowRunnable));
                }
                ...
                if(!isSuccess){
                    ...
                    if(rawHandler!=null && rawHandler instanceof Handler){
                        isSuccess=setFieldValue(rawHandler,"mCallback",
                                new InternalHandlerCallback((Handler)rawHandler));
                    }
                }
