...
import com.flym.fhzk.ui.fragment.mine.RebatesFragment;
...
public class RebatesActivity extends BaseActivity {
    ...
    protected void init(Bundle savedInstanceState) {
        FragmentUtil.replaceFragmentToActivity(R.id.container, RebatesFragment.newInstance(), getSupportFragmentManager());
    }
