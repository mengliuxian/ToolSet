...
import com.flym.fhzk.ui.fragment.mine.NewsFragment;
...
public class NewsActivity extends BaseActivity {
    ...
    protected void init(Bundle savedInstanceState) {
        FragmentUtil.replaceFragmentToActivity(R.id.container, NewsFragment.newInstance(), getSupportFragmentManager());
    }
