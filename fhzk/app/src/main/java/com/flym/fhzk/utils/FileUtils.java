...
public class FileUtils {
    ...
    public static void getFileUri(Activity context, int requestCode) {
    ...
    public static void openFile(final Context context, final String fileUrl) {
        final LoadingDialog show = LoadingDialog.show(context, "正在下载...");
//        RetrofitUtil.getApiService()
//                .getFile(ApiConstants.getFileUrl(ApiConstants.getFileUrl(fileUrl)))
//                .subscribeOn(Schedulers.io())
//                .observeOn(AndroidSchedulers.mainThread())
//                .subscribe(new DisposableWrapper<ResponseBody>() {
//                    @Override
//                    public void onNext(ResponseBody responseBody) {
//                        File file = FileUtils.writeResponseBodyToDisk(responseBody, context, getFileName(fileUrl));
