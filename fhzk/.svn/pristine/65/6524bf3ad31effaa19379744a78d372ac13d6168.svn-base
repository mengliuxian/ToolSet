...
import com.flym.fhzk.ui.fragment.mine.BindTBFragment;
...
public class BindTBActivity extends BaseActivity {
    ...
    protected void init(Bundle savedInstanceState) {
        FragmentUtil.replaceFragmentToActivity(R.id.container, BindTBFragment.newInstance(), getSupportFragmentManager());
    }
